...
class PatientCreateRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('patients.store');
    }
    ...
    public function rules()
    {
        return [
            ...
            'type_ident' => 'required',
            'identificacion' => ['unique:patients,identificacion','required','digits:10'],
    ...
    {
        $errors = array("No tiene permisos para agregar un paciente");
