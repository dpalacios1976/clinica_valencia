...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('results_exams_procedures', function (Blueprint $table) {
            $table->id();
            $table->text('observation')->comment('Observación del Resultado de Examenes y Procedimientos Dg Relevantes');
    ...
    {
        Schema::dropIfExists('results_exams_procedures');
    }
};
